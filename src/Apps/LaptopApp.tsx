...
export default function LaptopApp() {
    ...
    return <ChakraProvider theme={extendTheme({ fonts: { heading: "ABeeZee", body: "ABeeZee" } })}>
        ...
        <VStack spacing={24} py={24} bg="gray.800" justify="center">
            ...
            <Heading fontStyle="italic" color="#9DD1F1" as="h3">Who said that only food is cooked in a frying pan?</Heading>
            <NftCarousel />
            <br />
            ...
            <Heading fontStyle="italic"  color="#9DD1F1" as="h2">Road Map</Heading>
            <RoadMap />
        </VStack>

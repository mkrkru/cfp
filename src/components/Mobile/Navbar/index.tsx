        ...
        <Flex alignItems="center" justifyContent="space-between" h="10vh">
            ...
            <Flex alignItems="center" justifyContent="center">
                <ButtonGroup variant="ghost" color="gray.600">
                    <Link href="https://discord.com" isExternal><IconButton color="white" aria-label="Discord" icon={<FaDiscord fontSize="30px" />} /></Link>
                    <Link href="https://twitter.com" isExternal><IconButton color="white" aria-label="Twitter" icon={<FaTwitter fontSize="30px" />} /></Link>
                    <Link href="https://instagram.com" isExternal><IconButton color="white" aria-label="Instagram" icon={<FaInstagram fontSize="30px" />} /></Link>

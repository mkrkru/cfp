        ...
        <Flex alignItems="center" justifyContent="space-between" h={16}>
            ...
            <Flex alignItems="center" justifyContent="center">
                <ButtonGroup variant="ghost" color="gray.600">
                    <Link href="https://discord.com" isExternal><IconButton color="#9DD1F1" aria-label="Discord" icon={<FaDiscord fontSize="20px" />} /></Link>
                    <Link href="https://twitter.com" isExternal><IconButton color="#9DD1F1" aria-label="Twitter" icon={<FaTwitter fontSize="20px" />} /></Link>
                    <Link href="https://instagram.com" isExternal><IconButton color="#9DD1F1" aria-label="Instagram" icon={<FaInstagram fontSize="20px" />} /></Link>

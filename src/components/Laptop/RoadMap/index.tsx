...
export function RoadMap() {
    return <Xwrapper>
        <VStack spacing="16vh" shouldWrapChildren={true}>
            ...
            <Card pos={{ left: "0vh", borderTop: "#f2ff3d" }} id={'elem3'} image={Phase3} w={726} h={413} text={"Аttracting holders to the possibility of receiving passive income."} phase={"3"} />
            <Card pos={{ left: "20vh", borderTop: "#50ff6f" }} id={'elem4'} image={Phase4} w={800} h={536} text={"Release of generative collection."} phase={"4"} />
        </VStack>

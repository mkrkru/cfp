...
export function RoadMap() {
    return <Xwrapper>
        ...
        <Xarrow start={'elem1'} end={'elem2'} startAnchor={{ position: "auto", offset: { y: 10 } }} endAnchor={{ position: "auto", offset: { y: -10 } }} animateDrawing={0.1} />
        <Xarrow start={'elem2'} end={'elem3'} startAnchor={{ position: "auto", offset: { y: 10 } }} endAnchor={{ position: "auto", offset: { y: -10 } }} animateDrawing={0.1} />
        <Xarrow start={'elem3'} end={'elem4'} startAnchor={{ position: "auto", offset: { y: 10 } }} endAnchor={{ position: "auto", offset: { y: -10 } }} animateDrawing={0.1} />
    </Xwrapper>;
}